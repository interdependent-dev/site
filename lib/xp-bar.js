...
(function (global) {
  ...
  function injectStyles() {
    ...
    var css =
      ...
      '.idxp-g-x{background:none;border:1px solid #333;color:#aaa;width:30px;height:30px;border-radius:7px;cursor:pointer;display:flex;align-items:center;justify-content:center;line-height:0;flex-shrink:0}.idxp-g-x:hover{border-color:#777;color:#fff}.idxp-g-x svg{width:15px;height:15px;stroke:currentColor;stroke-width:2;fill:none;stroke-linecap:round;stroke-linejoin:round}' +
  ...
  function guideBody(cfg) {
    ...
    var slots = (cfg.credit && cfg.credit.slotsPerFilm) || 5;
    ...
    return '<div class="idxp-g-head"><h2>How Reader XP works</h2>' +
      '<button class="idxp-g-x" aria-label="Close"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg></button></div>' +
  ...
  function openGuide() {
    ...
    back.innerHTML = '<div class="idxp-guide" role="dialog" aria-modal="true" aria-label="How Reader XP works"><div class="idxp-g-loading">Loading…</div></div>';
